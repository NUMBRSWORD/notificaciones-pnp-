# Desplegar las 6 Edge Functions de IA
...
## Paso 2: desplegar cada función (repetir 6 veces)

Para cada una de estas 6 funciones:
...
6. Click en **Deploy**.
7. Repite con las otras 5.

## Paso 3: verificar

Cuando termines las 6, entra a la app (`http://localhost:5501` o tu link publicado) y prueba:
...
Si en algún momento instalas la [Supabase CLI](https://supabase.com/docs/guides/cli) en tu computadora, podrás desplegar las 6 de una sola vez sin copiar y pegar, ejecutando esto desde esta carpeta:
